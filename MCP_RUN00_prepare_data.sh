...
if [ $SRR == "SRR" ]
then
cp MCP.pc/PX_0201b_GEO_SC_SBAM_by_SNBC.py  MCP.pc/PX_0201_SC_SBAM_by_SNBC.py
else
cp MCP.pc/PX_0201a_ORI_SC_SBAM_by_SNBC.py  MCP.pc/PX_0201_SC_SBAM_by_SNBC.py
fi 
